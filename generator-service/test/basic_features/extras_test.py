...
class TestExtrasWorking(unittest.TestCase):
    def setUp(self):
        self.url_extras_single = "http://localhost:7860/api/extra-single-image"
        self.extras_single = {
            "resize_mode": 0,
...
class TestPngInfoWorking(unittest.TestCase):
    def setUp(self):
        self.url_png_info = "http://localhost:7860/api/extra-single-image"
        self.png_info = {
            "image": encode_pil_to_base64(Image.open(os.path.join(script_path, r"test/test_files/img2img_basic.png")))
        }
...
class TestInterrogateWorking(unittest.TestCase):
    def setUp(self):
        self.url_interrogate = "http://localhost:7860/api/extra-single-image"
        self.interrogate = {
            "image": encode_pil_to_base64(Image.open(os.path.join(script_path, r"test/test_files/img2img_basic.png"))),
            "model": "clip"
        }
