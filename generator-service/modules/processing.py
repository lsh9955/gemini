...
class StableDiffusionProcessing:
    ...
    """
    def __init__(self,
                 sd_model=None, user_id:str = "", outpath_samples=None, outpath_grids=None, prompt: str = "",
                 ...
                 sampler_name: str = None, batch_size: int = 1, n_iter: int = 1, steps: int = 50, cfg_scale: float = 7.0,
                 width: int = 512, height: int = 512, restore_faces: bool = False, tiling: bool = False,
                 ...
                 denoising_strength: float = 0, ddim_discretize: str = None, s_churn: float = 0.0,
                 s_tmax: float = None, s_tmin: float = 0.0, s_noise: float = 1.0, override_settings: Dict[str, Any] = None,
